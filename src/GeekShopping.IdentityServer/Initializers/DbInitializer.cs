...
namespace GeekShopping.IdentityServer.Initializers
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "gustavo-admin@nozzam.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (61) 8846-6852",
                FirstName = "Gustavo",
                LastName = "Admin"
            };

            _user.CreateAsync(admin, "Gustavo123$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "gustavo-client@nozzam.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (61) 98846-8846",
                FirstName = "Ferreira",
                LastName = "Client"
            };

            _user.CreateAsync(client, "Gustavo1234$").GetAwaiter().GetResult();
